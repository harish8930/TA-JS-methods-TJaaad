...
*/function addThree(num){
  ...
  */
  ...
  function isAdult(peopledetail){
  return peopledetail.age>18
  }
   isAdult(people)
  ...
  */
  ...
  function isGradeA(gradeD){
  return gradeD.grade > 12;
  }
  isGradeA(grades);
  ...
  */
  ...
  /*
    ...
    function isGradeA(gradeD){
  return gradeD.grade > 8 && gradeD.grade <= 12;
  }
  isGradeA(grades);
  console.log(isGradeA(grades[2]));
    EXAMPLE:
